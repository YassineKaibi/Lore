...
use veridikt_intent::{Finding, Intent, IntentNode, Kind, Origin, QName, Spanned};
...
pub(crate) fn build(
    ...
    // A veridikt.toml mapping originates a Module node (§4) unless a scoping
    ...
    // never reach this table — veridikt_derive excludes them (D-060d).
