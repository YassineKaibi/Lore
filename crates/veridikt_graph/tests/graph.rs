...
use veridikt_graph::{ClaimStatus, Confidence, DerivedLayer, EdgeKind, Graph, Layer};
use veridikt_intent::{
...
fn edges_from<'g>(g: &'g Graph, q: &str) -> Vec<&'g veridikt_graph::Edge> {
    g.out
...
fn co(lines: &str) -> veridikt_graph::Codeowners {
    veridikt_graph::codeowners::parse(".github/CODEOWNERS".into(), lines)
}
