...
//! line. The CLI owns the git boundary; `veridikt_graph::build` applies the
...
use veridikt_annotations::ScannedBlock;
use veridikt_graph::StalenessRecord;
use veridikt_intent::Span;
