...
//!
//! `lore_cli` is the only crate that names grammar crates; `lore_annotations`
//! and `lore_derive` receive the grammar handle from the loader (D-070d).

use super::PackSource;

/// Path to a builtin pack file, relative to this source file's directory
/// (`crates/lore_cli/src/packs/`), reaching the workspace-root `packs/` dir.
...
pub fn sources() -> Vec<PackSource> {
    vec![
        PackSource {
            name: "python".into(),
            manifest_path: "packs/python/lore-lang.toml".into(),
            manifest: pack_file!("python", "lore-lang.toml").into(),
        ...
        PackSource {
            ...
            manifest_path: "packs/typescript/lore-lang.toml".into(),
            manifest: pack_file!("typescript", "lore-lang.toml").into(),
        ...
        PackSource {
            name: "java".into(),
            manifest_path: "packs/java/lore-lang.toml".into(),
            manifest: pack_file!("java", "lore-lang.toml").into(),
